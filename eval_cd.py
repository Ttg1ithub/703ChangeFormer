...
def main():
    ...
    parser.add_argument('--checkpoints_root', default='/mnt/backup/gcw-yhj/checkpoints/ChangeFormer', type=str)
    parser.add_argument('--vis_root', default='/mnt/backup/gcw-yhj/vis', type=str)
